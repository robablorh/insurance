    ...
    <Container>
        <div className="btn-group w-100" role="group" aria-label="Button group with 4 buttons">
         ...
         <div className="shifttypes">
           ...
           <div className="btn-group w-100" role="group" aria-label="Button group with 4 buttons">
               <button onClick={ navthree} type="button" className="btn btn-primary" style={{ backgroundColor: "rgb(53, 20, 125)", padding: "1.5rem" }}>3months</button>
               ...
               <button onClick={ navone} type="button" className="btn btn-primary" style={{ backgroundColor: "rgb(175, 149, 231)", padding: "1.5rem" }}>1year</button>
         ...
         <Container>
               ...
               <Col ><p  className="brk">Coverts death, bodily injury, damage to other persons property, fire, theft, windscreen and accidental damage to your car</p></Col><Col> GhS 8000</Col>
               </Row>
               <Row>
                 <h4>Third-Party Insurance</h4>
               <Col ><p  className="brk">Coverts death, bodily injury, damage to other persons property, fire, theft, windscreen and accidental damage to your car</p></Col> <Col> GhS 3200</Col>
               </Row>
               <Row>
                 <h4>Third-Party Fire and Theft Insurance</h4>
               <Col ><p  className="brk"> Coverts death, bodily injury, damage to other persons property, fire, theft, windscreen and accidental damage to your car</p></Col><Col> GhS 2400</Col>
               </Row>
