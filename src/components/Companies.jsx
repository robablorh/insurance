                ...
                <div>
                  ...
                  <form onSubmit={resetForm} className="">
                    <div className="form-group d-flex align-items-center">
                      <label className="form-label mb-4 me-4" htmlFor="name">
                        Name:{" "}
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="form-group d-flex align-items-center">
                      <label className="form-label mb-4 me-4" htmlFor="email">
                        Email:{" "}
                      </label>
                      <input
                        type="text"
                    ...
                    <div
                      ...
                      style={{ display: "flex" }}
                    >
                      <label className="form-label mb-4 me-3" htmlFor="phone">
                        Phone:{" "}
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="form-group">
                      <PaystackButton
                        className="btn btn-primary px-4 py-2 paystack-button"
                        {...componentProps}
                      />
